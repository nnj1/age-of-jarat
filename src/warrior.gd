...
func prepare(spawning_player_id: int = 1, given_faction:int = randi_range(0, 1), given_lore_data = GlobalVars.filter_json_objects(GlobalVars.lore.units, 'type', 'warrior').pick_random()):
